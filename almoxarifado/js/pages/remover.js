/* ============================================
   ALMOXARIFADO TI — pages/remover.js
   Lógica da página Remover Item
   ============================================ */

function populateRemSelect() {
...
function confirmarRemocao() {
  ...
  openModal(
    'Remover item',
    `Tem certeza que deseja remover "<strong>${esc(item.nome || item.codigo)}</strong>"?
